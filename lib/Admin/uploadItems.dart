...
File file;
  ...
  displayAdminUploadFormScreen() {
    ...
    appBar: AppBar(
      ...
      actions: [
        FlatButton(onPressed: uploading ? null : () => uploadImageAndSaveItem() ,
      ...
      body: ListView(
        children: [
          uploading ?
          circularProgress() : Fluttertoast.showToast(msg: "Item has been added successfully."),
          Container(
            height: 230.0,
          ...
          ListTile(
            ...
            title: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: "Short Info about the product",
                  hintStyle: TextStyle(color: Colors.deepPurpleAccent),
                  border: InputBorder.none,
                ),
              ),
  ...
  Future<String> uploadItemImage(mfile) async{
    ...
    StorageUploadTask uploadTask = storageReference.child("product_$productId.jpg").putFile(mfile);
  ...
  saveItemInfo(String downloadUrl){
    ...
    itemsRef.document(productId).setData({
      ...
      "price":int.parse( _priceTEC.text),
