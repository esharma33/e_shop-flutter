...
class _AdminSignInScreenState extends State<AdminSignInScreen>
{
  ...
  final TextEditingController _adminIdTEC = TextEditingController();
        ...
        child: Column(
          ...
          children: [
            ...
            FlatButton.icon(
              ...
              label: Text("I'm not the Admin" ,style: TextStyle(color: Colors.pink,fontWeight: FontWeight.bold),),
            ),
            SizedBox(height: 50.0,),
          ],
        ),
  ...
  Firestore.instance.collection("admins").getDocuments().then((snapshot){
    ...
    snapshot.documents.forEach((result){
     if(result.data["id"] != _adminIdTEC.text.trim()){
       Scaffold.of(context).showSnackBar(SnackBar(content: Text("Your ID is not Correct."),));

     }else if(result.data["password"] != _passwordTEC.text.trim()){
