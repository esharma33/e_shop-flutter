            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (context , dataSnapshot) {
                ...
                SliverToBoxAdapter(child: Center(child: circularProgress(),),)
                    : SliverStaggeredGrid.countBuilder(crossAxisCount: 1,
            ...
            Expanded(
             ...
             Row(
              ...
              height: 43.0,
                     ...
                     Padding(
                       ...
                       child: Row(
                         children: [
                           Text(
                             "Original Price: ₹ ",
                             style: TextStyle(fontSize: 14.0 , color: Colors.grey, decoration: TextDecoration.lineThrough,
                             ),
                           ),
                           Text(
                ...
                //to implement the cart item remove item..
                Align(
...
Widget card({Color primaryColor = Colors.redAccent, String imgPath}) {
  return Container(
    ...
    child: ClipRRect(
      borderRadius: BorderRadius.all(Radius.circular(20.0)),
      child: Image.network(imgPath , height: 150.0 , width: width * 0.34, fit: BoxFit.fill,
    ),
    ),
  );
}
...
void checkItemInCart(String shortInfoAsId, BuildContext context)
{
  EcommerceApp.sharedPreferences.getStringList(EcommerceApp.userCartList).contains(shortInfoAsId)
      ...
      : addItemInCart(shortInfoAsId , context);
}
addItemInCart(String shortId , BuildContext context){
  List temptCartlist = EcommerceApp.sharedPreferences.getStringList(EcommerceApp.userCartList);
  temptCartlist.add(shortId);
  
  EcommerceApp.firestore.collection(EcommerceApp.collectionUser)
  .document(EcommerceApp.sharedPreferences.getString(EcommerceApp.userUID))
  .updateData({
    EcommerceApp.userCartList: temptCartlist,
  }).then((v){
    Fluttertoast.showToast(msg: "Item added to cart. ");
    EcommerceApp.sharedPreferences.setStringList(EcommerceApp.userCartList, temptCartlist );
